(function(){
    layui.use('table', function() {
        ...
        table.on('toolbar(testdome)', function(obj) {
            ...
            switch (obj.event) {
                case 'add':
                    window.location.href = "./dialog/advicedialog.html";
                    break;
                case 'update':
                    if (data.length === 0) {
                        layer.msg('请选择一行');
                        ...
                        // layer.alert('编辑 [id]：' + checkStatus.data[0].id);
                         window.location.href = "./dialog/advicedialog.html?id="+data[0].id;
                    }
                    break;
                case 'delete':
                    if (data.length === 0) {
        ...
        // 删除
        function delBasExpertarticle(id){
            handleAjax('expert/delBasExpertarticle', { id: id }, "POST").done(function(resp) {
                console.log(resp)
                layer.msg('删除成功');
                setTimeout(function(){
                    getBasExpertarticle();
        ...
        function getBasExpertarticle(){
            ...
            table.render({
                elem: '#test',
                url: base + "expert/getBasExpertarticle",
                method: "GET",
